      ...
      <div className="mx-auto px-6 max-w-7xl">
        <div className="flex flex-col items-center mx-auto max-w-4xl text-center">
          ...
          <h1 className="slide-in-from-bottom-4 mb-6 font-black text-zinc-900 text-5xl md:text-7xl leading-[0.9] tracking-tighter animate-in duration-1000 fade-in">
            High-Performance <span className="text-orange-500">Websites</span> for Ambitious Brands.
          </h1>

          {/* SUB-HEADLINE (Who we do it for & What we do) */}
          <p className="slide-in-from-bottom-5 mb-10 max-w-2xl text-zinc-500 text-lg md:text-xl leading-relaxed animate-in duration-1000 fade-in">
            At <span className="font-semibold text-zinc-900">{siteConfig.name}</span>, we help Kenyan businesses and global startups turn their digital presence into a high-converting growth engine through modern engineering and strategic SEO.
          </p>
          ...
          <div className="gap-8 grid grid-cols-1 md:grid-cols-3 mt-20 pt-10 border-zinc-100 border-t w-full animate-in duration-1000 delay-300 fade-in zoom-in">
            <div className="flex justify-center md:justify-start items-center gap-3">
              ...
              <span className="font-bold text-zinc-700 text-sm uppercase tracking-tight">Speed Optimized</span>
            </div>
            <div className="flex justify-center items-center gap-3">
              <div className="bg-zinc-50 p-2 rounded-lg text-zinc-600">
                <Target size={20} />
              </div>
              <span className="font-bold text-zinc-700 text-sm uppercase tracking-tight">SEO Driven Results</span>
            </div>
            <div className="flex justify-center md:justify-end items-center gap-3">
              <div className="bg-zinc-50 p-2 rounded-lg text-zinc-600">
                <ShieldCheck size={20} />
              </div>
              <span className="font-bold text-zinc-700 text-sm uppercase tracking-tight">Secure & Scalable</span>
            </div>
          </div>
